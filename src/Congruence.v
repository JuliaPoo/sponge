...
Section egraphs.
    ...
    let eapp_gather_to_change :=
      PTree.tree_fold_preorder (fun acc val  =>
        PTree.tree_fold_preorder (fun acci '(enode,eid) =>
                                    match enode with
                                    | EApp a b =>
                                    (* TODO do not append if this EApp is already there *)
                                      (EApp (find uf a) (find uf b), find uf eid)::acci
                                    | _ => acci
                                    end) val acc) apps nil in
    EGraphList.fold_left (fun acc '(enode,eid) =>
      add_enode acc enode eid) eapp_gather_to_change (atms, PTree.empty _).
  ...
  Definition propagate_merge_1 (e : egraph) : egraph :=
    (* e2 is the new canonical representant *)
...
Import List.ListNotations.
  ...
  Lemma simplification1: forall (a: word) (w1_0 w2_0 w1 w2: word) (vs: list word)
        ...
        (lol_hyp : (Some _ (unsigned b) = Some _ 3))
        (H : sep (word_array a
          (List.firstn
             (Z.to_nat (unsigned (wsub (wadd a (ZToWord 8)) a) / 4))
             ((if cond0_0 then [w1_0] else if cond0 then [w2_0] else List.firstn 1 vs) ++
  ...
  Proof.
    ...
    Undelimit Scope list_scope.
    {
      ...
      eggify lol_hyp.
      eggify_goal.
      (eapply (@rew_zoom_bw _ 3 _  (EGGTHSSSSOH0 _ _ _ _) (fun hole => (@eq Z (@myabs hole) 3))) || 
      eapply (@rew_zoom_bw _ 3 _  (prove_True_eq _ (EGGTHSSSSOH0 _ _ _ _)) (fun hole => (@eq Z (@myabs hole) 3))));
      (eapply (@rew_zoom_bw _ 3 _  (EGGTHSSOH3 _ _) (fun hole => (@eq Z hole 3))) || 
      eapply (@rew_zoom_bw _ 3 _  (prove_True_eq _ (EGGTHSSOH3 _ _)) (fun hole => (@eq Z hole 3))));
      idtac.
      constructor.
      Unshelve.
      all: cbv [qmid]; eauto.
    ...
    eapply (@rew_zoom_fw _ (@wadd a b) _  (prove_True_eq _ (EGGTHSSOwadd_comm _ _)) (fun hole => (@and (@eq word (@f hole) (@g b)) (@and (@sep R (@word_array a (@cons word v0 (@cons word w1 (@cons word w2 (@nil word))))) m) (@eq word (@f (@wadd b a)) (@f (@wadd a b))))))));
    ...
    eapply (@rew_zoom_fw _ (@f (@wadd a b)) _  (prove_True_eq _ EGGHYPhyp_missing) (fun hole => (@and (@eq word (@f (@wadd a b)) hole) (@and (@sep R (@word_array a (@cons word v0 (@cons word w1 (@cons word w2 (@nil word))))) m) (@eq word (@f (@wadd b a)) (@f (@wadd a b))))))));
    ...
    eapply (@rew_zoom_bw _ True _  (prove_True_eq _ (EGGTHSOeq_eq_True _)) (fun hole => (@and hole (@and (@sep R (@word_array a (@cons word v0 (@cons word w1 (@cons word w2 (@nil word))))) m) (@eq word (@f (@wadd b a)) (@f (@wadd a b))))))));
    ...
    eapply (@rew_zoom_bw _ (@and (@sep R (@word_array a (@cons word v0 (@cons word w1 (@cons word w2 (@nil word))))) m) (@eq word (@f (@wadd b a)) (@f (@wadd a b)))) _  (prove_True_eq _ (EGGTHSOand_True_l _)) (fun hole => hole)));
    ...
    eapply (@rew_zoom_bw _ (@g b) _  (prove_True_eq _ EGGHYPhyp_missing) (fun hole => (@and (@sep R (@word_array a (@cons word v0 (@cons word w1 (@cons word w2 (@nil word))))) m) (@eq word (@f (@wadd b a)) hole)))));
    ...
    eapply (@rew_zoom_fw _ (@wadd a b) _  (prove_True_eq _ (EGGTHSSOwadd_comm _ _)) (fun hole => (@and (@sep R (@word_array a (@cons word v0 (@cons word w1 (@cons word w2 (@nil word))))) m) (@eq word (@f hole) (@g b))))));
    ...
    eapply (@rew_zoom_fw _ (@f (@wadd a b)) _  (prove_True_eq _ EGGHYPhyp_missing) (fun hole => (@and (@sep R (@word_array a (@cons word v0 (@cons word w1 (@cons word w2 (@nil word))))) m) (@eq word (@f (@wadd a b)) hole)))));
    ...
    eapply (@rew_zoom_bw _ True _  (prove_True_eq _ (EGGTHSOeq_eq_True _)) (fun hole => (@and (@sep R (@word_array a (@cons word v0 (@cons word w1 (@cons word w2 (@nil word))))) m) hole))));
    ...
    eapply (@rew_zoom_bw _ (@sep R (@word_array a (@cons word v0 (@cons word w1 (@cons word w2 (@nil word))))) m) _  (prove_True_eq _ (EGGTHSOand_True_r _)) (fun hole => hole)));
    ...
    eapply (@rew_zoom_bw _ (@sep (@word_array a (@cons word v0 (@cons word w1 (@cons word w2 (@nil word))))) R m) _  (prove_True_eq _ (EGGTHSSSOsep_comm _ _ _)) (fun hole => hole)));
    ...
    eapply (@rew_zoom_fw _ (@app word (@nil word) (@cons word w2 (@nil word))) _  (prove_True_eq _ (EGGTHSOapp_nil_l _)) (fun hole => (@sep (@word_array a (@cons word v0 (@cons word w1 hole))) R m))));
    ...
    eapply (@rew_zoom_bw _ (@app word (@cons word w1 (@nil word)) (@cons word w2 (@nil word))) _  (prove_True_eq _ (EGGTHSSSOapp_cons _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 hole)) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.firstn word MyO (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))) _  (prove_True_eq _ (EGGTHSOfirstn_O _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@cons word w1 hole) (@cons word w2 (@nil word))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.firstn word (@MySuc MyO) (@cons word w1 (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) _  (prove_True_eq _ (EGGTHSSSOfirstn_cons _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word hole (@cons word w2 (@nil word))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@app word (@nil word) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))) _  (prove_True_eq _ (EGGTHSOapp_nil_l _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@cons word w1 hole)) (@cons word w2 (@nil word))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))) _  (prove_True_eq _ (EGGTHSSSOour_app_cons _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) hole) (@cons word w2 (@nil word))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.skipn word MyO (@nil word)) _  (prove_True_eq _ (EGGTHSOskipn_O _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 hole)))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.skipn word (@MySuc MyO) (@cons word v2 (@nil word))) _  (prove_True_eq _ (EGGTHSSSOskipn_cons _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 hole)))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.skipn word MyO (@cons word v2 (@nil word))) _  (prove_True_eq _ (EGGTHSOskipn_O _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@MySuc MyO) hole))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.skipn word (@MySuc MyO) (@cons word v1 (@cons word v2 (@nil word)))) _  (prove_True_eq _ (EGGTHSSSOskipn_cons _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@MySuc MyO) hole))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) _  (prove_True_eq _ (EGGTHSSSOskipn_cons _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@MySuc MyO) hole))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word w1 (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) _  (prove_True_eq _ (EGGTHSSSOskipn_cons _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 hole)))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@Z.to_nat (@mydiv 8 4)) _  (prove_True_eq _ EGGHYPC1) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word hole (@cons word w1 (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@unsigned (@ZToWord 8)) _  (prove_True_eq _ EGGHYPA1) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv hole 4)) (@cons word w1 (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@wadd (@ZToWord 0) (@ZToWord 8)) _  (prove_True_eq _ (EGGTHSOwadd_0_l _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv (@unsigned hole) 4)) (@cons word w1 (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@wadd a (@wopp a)) _  (prove_True_eq _ (EGGTHSOwadd_opp _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv (@unsigned (@wadd hole (@ZToWord 8))) 4)) (@cons word w1 (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    (eapply (@rew_zoom_bw _ (@wadd (@wopp a) a) _  (EGGTHSSOwadd_comm _ _) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv (@unsigned (@wadd hole (@ZToWord 8))) 4)) (@cons word w1 (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))) || 
    eapply (@rew_zoom_bw _ (@wadd (@wopp a) a) _  (prove_True_eq _ (EGGTHSSOwadd_comm _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv (@unsigned (@wadd hole (@ZToWord 8))) 4)) (@cons word w1 (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    (eapply (@rew_zoom_fw _ (@wadd (@wopp a) (@wadd a (@ZToWord 8))) _  (EGGTHSSSOwadd_assoc _ _ _) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv (@unsigned hole) 4)) (@cons word w1 (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))) || 
    eapply (@rew_zoom_fw _ (@wadd (@wopp a) (@wadd a (@ZToWord 8))) _  (prove_True_eq _ (EGGTHSSSOwadd_assoc _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv (@unsigned hole) 4)) (@cons word w1 (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    (eapply (@rew_zoom_fw _ (@wadd (@wadd a (@ZToWord 8)) (@wopp a)) _  (EGGTHSSOwadd_comm _ _) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv (@unsigned hole) 4)) (@cons word w1 (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))) || 
    eapply (@rew_zoom_fw _ (@wadd (@wadd a (@ZToWord 8)) (@wopp a)) _  (prove_True_eq _ (EGGTHSSOwadd_comm _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv (@unsigned hole) 4)) (@cons word w1 (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@app word (@nil word) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))) _  (prove_True_eq _ (EGGTHSOapp_nil_l _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4)) (@cons word w1 hole)))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))) _  (prove_True_eq _ (EGGTHSSSOour_app_cons _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4)) hole))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@app word (@nil word) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) _  (prove_True_eq _ (EGGTHSOapp_nil_l _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4)) hole))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.firstn word MyO (@cons word v1 (@cons word v2 (@nil word)))) _  (prove_True_eq _ (EGGTHSOfirstn_O _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4)) (@app word hole (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@cons word v0 (@app word (@List.firstn word MyO (@cons word v1 (@cons word v2 (@nil word)))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))) _  (prove_True_eq _ (EGGTHSSSOskipn_cons _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 hole)))) R m))));
    ...
    eapply (@rew_zoom_bw _ (@nil word) _  (prove_True_eq _ (EGGTHSOfirstn_O _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@cons word v0 (@app word hole (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))))) R m))));
    ...
    eapply (@rew_zoom_bw _ (@app word (@cons word v0 (@nil word)) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) _  (prove_True_eq _ (EGGTHSSSOapp_cons _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) hole))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) _  (prove_True_eq _ (EGGTHSSSOfirstn_cons _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word hole (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@app word (@nil word) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))) _  (prove_True_eq _ (EGGTHSOapp_nil_l _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) (@cons word w2 hole)))) R m))));
    ...
    eapply (@rew_zoom_bw _ (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))) _  (prove_True_eq _ (EGGTHSSSOapp_cons _ _ _)) (fun hole => (@sep (@word_array a (@cons word v0 (@app word (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) hole))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@app word (@cons word v0 (@List.firstn word (@MySuc MyO) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))))) _  (prove_True_eq _ (EGGTHSSSOour_app_cons _ _ _)) (fun hole => (@sep (@word_array a hole) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.firstn word (@MySuc (@MySuc MyO)) (@cons word v0 (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) _  (prove_True_eq _ (EGGTHSSSOfirstn_cons _ _ _)) (fun hole => (@sep (@word_array a (@app word hole (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@Z.to_nat (@mydiv 8 4)) _  (prove_True_eq _ EGGHYPC1) (fun hole => (@sep (@word_array a (@app word (@List.firstn word hole (@cons word v0 (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@unsigned (@ZToWord 8)) _  (prove_True_eq _ EGGHYPA1) (fun hole => (@sep (@word_array a (@app word (@List.firstn word (@Z.to_nat (@mydiv hole 4)) (@cons word v0 (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@wadd (@ZToWord 0) (@ZToWord 8)) _  (prove_True_eq _ (EGGTHSOwadd_0_l _)) (fun hole => (@sep (@word_array a (@app word (@List.firstn word (@Z.to_nat (@mydiv (@unsigned hole) 4)) (@cons word v0 (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@wadd a (@wopp a)) _  (prove_True_eq _ (EGGTHSOwadd_opp _)) (fun hole => (@sep (@word_array a (@app word (@List.firstn word (@Z.to_nat (@mydiv (@unsigned (@wadd hole (@ZToWord 8))) 4)) (@cons word v0 (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    (eapply (@rew_zoom_bw _ (@wadd (@wopp a) a) _  (EGGTHSSOwadd_comm _ _) (fun hole => (@sep (@word_array a (@app word (@List.firstn word (@Z.to_nat (@mydiv (@unsigned (@wadd hole (@ZToWord 8))) 4)) (@cons word v0 (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))) || 
    eapply (@rew_zoom_bw _ (@wadd (@wopp a) a) _  (prove_True_eq _ (EGGTHSSOwadd_comm _ _)) (fun hole => (@sep (@word_array a (@app word (@List.firstn word (@Z.to_nat (@mydiv (@unsigned (@wadd hole (@ZToWord 8))) 4)) (@cons word v0 (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    (eapply (@rew_zoom_fw _ (@wadd (@wopp a) (@wadd a (@ZToWord 8))) _  (EGGTHSSSOwadd_assoc _ _ _) (fun hole => (@sep (@word_array a (@app word (@List.firstn word (@Z.to_nat (@mydiv (@unsigned hole) 4)) (@cons word v0 (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))) || 
    eapply (@rew_zoom_fw _ (@wadd (@wopp a) (@wadd a (@ZToWord 8))) _  (prove_True_eq _ (EGGTHSSSOwadd_assoc _ _ _)) (fun hole => (@sep (@word_array a (@app word (@List.firstn word (@Z.to_nat (@mydiv (@unsigned hole) 4)) (@cons word v0 (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    (eapply (@rew_zoom_fw _ (@wadd (@wadd a (@ZToWord 8)) (@wopp a)) _  (EGGTHSSOwadd_comm _ _) (fun hole => (@sep (@word_array a (@app word (@List.firstn word (@Z.to_nat (@mydiv (@unsigned hole) 4)) (@cons word v0 (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))) || 
    eapply (@rew_zoom_fw _ (@wadd (@wadd a (@ZToWord 8)) (@wopp a)) _  (prove_True_eq _ (EGGTHSSOwadd_comm _ _)) (fun hole => (@sep (@word_array a (@app word (@List.firstn word (@Z.to_nat (@mydiv (@unsigned hole) 4)) (@cons word v0 (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@app word (@cons word v0 (@List.firstn word MyO (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))) _  (prove_True_eq _ (EGGTHSSSOour_app_cons _ _ _)) (fun hole => (@sep (@word_array a (@app word (@List.firstn word (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4)) hole) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    ...
    eapply (@rew_zoom_fw _ (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) _  (prove_True_eq _ (EGGTHSSSOfirstn_cons _ _ _)) (fun hole => (@sep (@word_array a (@app word (@List.firstn word (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4)) (@app word hole (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word)))))))) (@app word (@cons word w2 (@nil word)) (@List.skipn word (@MySuc (@Z.to_nat (@mydiv (@unsigned (@wadd (@wadd a (@ZToWord 8)) (@wopp a))) 4))) (@app word (@List.firstn word (@MySuc MyO) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))) (@app word (@cons word w1 (@nil word)) (@List.skipn word (@MySuc (@MySuc MyO)) (@cons word v0 (@cons word v1 (@cons word v2 (@nil word))))))))))) R m))));
    (eapply (@rew_zoom_bw _ True _  EGGHYPH (fun hole => hole)) || 
    eapply (@rew_zoom_bw _ True _  (prove_True_eq _ EGGHYPH) (fun hole => hole)));
    idtac.
    constructor.
    Time Qed.
End WithLib. 
